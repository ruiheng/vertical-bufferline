...
run_check "scripts/history_nav_pinned_test.lua"
...
run_check "scripts/groups_file_roundtrip_check.lua"
...
run_check "scripts/menu_details_toggle_test.lua"
run_check "scripts/components_git_lsp_test.lua"
...
run_check "scripts/pick_interrupt_exit_test.lua"
run_check "scripts/pick_ctrlc_exit_test.lua"
run_check "scripts/pick_esc_exit_test.lua"
run_check "scripts/pick_unique_match_duplicate_test.lua"
run_check "scripts/pick_match_bufferid_test.lua"
run_check "scripts/picker_group_switch_no_focus_check.lua"
