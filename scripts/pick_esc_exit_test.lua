...
vim.schedule(function()
    vim.api.nvim_feedkeys("\027", "tn", false)
end)
vbl.pick_close_buffer()

vim.wait(50)
assert_ok(not state.get_extended_picking_state().is_active, "expected pick close mode to exit on Esc")
